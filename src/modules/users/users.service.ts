...
export class UsersService {
    ...
    async editProfile(id: Types.ObjectId, data: ProfileInput) {
        ...
        if (data?.facebook?.length >= 30 || data?.instagram?.length >= 30 || data?.reddit?.length >= 30 || data?.twitter?.length >= 30 || data?.discord?.length >= 30 || data?.youtube?.length >= 30 || data?.tiktok?.length >= 30 ||  data?.web?.length >= 30 ) {
