export const invitation_mintstartgram = (username, code) => {
    return `
    <!DOCTYPE html>
    <html>
      <head>
        ...
        <title>Mintstartgram | Like</title>
        ...
        <style>
          * {
          ...
          @font-face {
            ...
            src: url("https://mintstartgram-git-develop-meta-ruffy.vercel.app/assets/fonts/ProximaNova-Bold.woff2")
              format("woff2");
            font-weight: 700;
            font-style: normal;
          }
          @font-face {
            ...
            src: url("https://mintstartgram-git-develop-meta-ruffy.vercel.app/assets/fonts/ProximaNova-Regular.woff2")
              format("woff2");
            font-weight: 400;
            font-style: normal;
          }
        ...
        <div style="overflow: hidden; display: flex; background: #fff">
          ...
          >
            <div
              ...
              "
            >
              <!-- src="https://mintstartgram-git-develop-meta-ruffy.vercel.app/assets/images/mail-logo.svg" -->
    
              <a href="javascript:void(0);" style="display: block">
                <img
                  src="https://dev.mintstartgram.com/assets/images/logo.svg"
            ...
            >
              ...
              <div style="text-align:  center;">
                ...
                ">You have been invited by <span style="color: #f1c94a;">
                    ${username}
                </span>  to join mintstartgram.com</p>
              ...
              <a href="mintstartgram.com" style="display: block;text-decoration:none">
              <p  style=" color: #f1c94a;  text-align: center; font-size: 12px; margin-top: 20px; text-decoration:none;
              font-family: proxima_novabold; cursor: pointer">Go to Mintstartgram.com</p>
