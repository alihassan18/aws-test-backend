export const offerReceived = (
  ...
  <html>
	<head>
	  ...
	  <title>Mintstartgram | Offer Received</title>
		  ...
		  >
			<div style="width: 100%; float: left">
			  <h1
				...
				"
			  >
			  Someone made an offer on your item!
			  </h1>
			  <p
				style="
				  margin: 8px 0 0;
				...
				"
			  >
			  You have an offer of ${price} ${currency} for your NFT ${title} on Mintstartgram
			  </p>
			</div>
			<div
			  style="
