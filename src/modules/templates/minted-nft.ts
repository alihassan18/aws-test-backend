export const mintedNFT = (name: string, image: string, url: string) => {
    return `
    <!DOCTYPE html>
  <html>
	<head>
	  ...
	  <title>Mintstartgram | Minted</title>
		  ...
		  >
			<div style="width: 100%; float: left">
			  ...
			  <p
				...
				"
			  >
			  You'r NFT ${name} is minted on Mintstartgram. You can list it to marketplace.
			  </p>
			</div>
			<div
			  style="
